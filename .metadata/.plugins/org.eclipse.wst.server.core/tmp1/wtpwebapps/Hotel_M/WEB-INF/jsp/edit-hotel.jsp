            ...
            <div class="col-md-6 text-center">
                <fieldset class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <input name="name" id="name" path="name" type="text" class="form-control" value="${hotel.name}"   />
                        </div>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6 text-center">
                <fieldset class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <input id="address" name="address" path="address" type="text" class="form-control" value="${hotel.address}"   />
                        </div>
                    </div>
                </fieldset>
            </div>
            ...
            <div class="col-md-6 text-center">
                <fieldset class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <input name="phone" id="phone" path="phone" type="text" class="form-control" value="${hotel.phone}"   />
                        </div>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6 text-center">
                <fieldset class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <input name="category" id="category" path="category" type="number" class="form-control" value="${hotel.category}" min="1" max="5" />
                        </div>
                    </div>
                </fieldset>
            </div>
